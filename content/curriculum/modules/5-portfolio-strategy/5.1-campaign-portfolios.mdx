...
If Campaign A is performing well, it can spend up to that remaining ₱100
before the portfolio's ₱2,000 ceiling stops the group. It cannot spend
₱200 more: only ₱100 of headroom exists under this ceiling today,
whatever Campaign A's own individual daily budget might otherwise allow.
```
