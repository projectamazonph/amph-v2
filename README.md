...
| Sprint 6 — Payments | ⏳ In progress (3/4) | 3 / 4 |
...
**Next: Sprint 6 STORY-029.** BIR-compliant receipt PDFs (sequential numbering + Vercel Blob). `Invoice` table already in Sprint 6 migration.
