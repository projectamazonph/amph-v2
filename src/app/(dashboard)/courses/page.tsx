...
export default async function CoursesIndexPage() {
  ...
  // Get all published lesson IDs to scope our query and prevent loading entire user progress history
  const allLessonIds = courses.flatMap((c) => c.modules.flatMap((m) => m.lessons.map((l) => l.id)));

  // Get user's lesson progress (optimized with scoped query to prevent large payloads and high memory consumption)
