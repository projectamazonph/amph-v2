...
export default async function DashboardPage() {
  ...
  // Bolt optimization: Scope lessonProgress query to published course lesson IDs
  // to avoid loading un-scoped progress records from other courses/deleted items.
