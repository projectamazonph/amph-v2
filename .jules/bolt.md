...
## 2026-07-17 - [Redundant Database Queries during Multi-Rule Evaluation]
...
**Action:** Use a request-scoped query-promise cache inside multi-rule evaluators to deduplicate database queries, ensuring the event loop can resolve database calls concurrently while avoiding redundant roundtrips.
